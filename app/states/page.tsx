...
export default function StatesPage() {
  // قائمة ولايات السودان الـ 18 كاملة ومصنفة
  const states = [
    "الخرطوم",
    "الجزيرة",
    "نهر النيل",
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-bold flex items-center gap-2">
            ...
            البحث حسب الولاية (جميع الولايات الـ 18)
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {states.map((stateName, index) => (
            <Link 
              ...
              className="bg-[#081322] border border-white/10 hover:border-[#0EA5A5] p-4 rounded-xl text-center transition flex flex-col items-center justify-center gap-2 group hover:bg-[#0c1a2e]"
            >
